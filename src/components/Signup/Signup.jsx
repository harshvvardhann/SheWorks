    ...
    <div className="signup-form-container">
      <div className="signup-form-card">
          ...
          <div className="signup-form-role-container">
            ...
            <div className="signup-form-role-options">
              <div className="signup-form-role-option">
                ...
                />
                <label htmlFor="role-entrepreneur" className="signup-form-role-label">Entrepreneur</label>
              </div>
              <div className="signup-form-role-option">
                <input
                  type="radio"
                  ...
                  className="signup-form-role-radio"
                />
                <label htmlFor="role-investor" className="signup-form-role-label">Investor</label>
              </div>
              <div className="signup-form-role-option">
                <input
                  type="radio"
                  ...
                  className="signup-form-role-radio"
                />
                <label htmlFor="role-mentor" className="signup-form-role-label">Mentor</label>
              </div>
            </div>
          </div>
        ...
        <div className="signup-form-toggle">
          <p className="signup-form-toggle-text">
