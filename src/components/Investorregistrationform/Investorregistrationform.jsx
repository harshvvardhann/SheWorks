      ...
      <div className="form-box">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <label className="checkbox-label">
            <input type="checkbox" name="mentorship" checked={formData.mentorship} onChange={handleChange} />
            I am interested in providing free mentorship to entrepreneurs.
          </label>
          <label className="checkbox-label">
            <input type="checkbox" name="receiveMails" checked={formData.receiveMails} onChange={handleChange} />
