...
import "./Mentor-registration.css";
      ...
      <div className="mentor-form-box">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mentor-form-row">
            <div className="mentor-form-group">
              <label>Expertise <span className="required">*</span></label>
              <select 
                name="expertise" 
          ...
          <div className="mentor-checkbox-container">
            <label className="mentor-checkbox-label">
              <input 
                type="checkbox" 
                name="offerOneOnOne" 
                checked={formData.offerOneOnOne} 
                onChange={handleChange} 
              />
          ...
          <button type="submit" className="mentor-submit-button">Register</button>
        </form>
      </div>
    </div>
  );
