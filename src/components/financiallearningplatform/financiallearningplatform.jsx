    ...
    const fundingStages = [
        {
            ...
            terms: [
                ...
                {
                    name: 'Angel Investor',
                    description: 'High-net-worth individuals who provide capital for startups, typically in exchange for equity or convertible debt.',
                    examples: 'Arlan Hamilton of Backstage Capital started as an angel investor focused on underrepresented founders.'
                },
                {
                    name: 'Pitch Deck',
                    description: 'A brief presentation that provides investors with an overview of your business plan, products, and growth potential.',
        ...
        },
        {
            ...
            terms: [
                ...
                },
                {
                    ...
                    examples: 'If an investor owns 5% of your company, pro rata rights allow them to invest enough to maintain that 5% in the next round.'
                },
                {
                ...
                },
                {
                    ...
                    examples: 'Tracking your cap table early helps avoid dilution issues when scaling. Companies like Carta help manage cap tables.'
                },
                {
                    name: 'Burn Rate',
                    description: 'The rate at which a company spends its cash reserves before generating positive cash flow.',
                    examples: 'A startup with $1M in the bank and monthly expenses of $100K has a 10-month runway before needing additional funding.'
                },
                {
        ...
        },
        {
          ...
          examples: 'Aileen Lee from Cowboy Ventures often takes board seats in her investments and mentors female founders.'
        },
                {
                    ...
                    description: 'Provision that determines the order and amount in which investors get paid in case of a liquidation event.',
                    examples: 'A 1x liquidation preference means investors get their money back before other shareholders receive anything.'
                },
                {
                    name: 'Lead Investor',
                    description: 'The venture capital firm or investor that puts in the largest amount of money and typically sets the terms of the round.',
                    examples: 'When 23andMe raised their Series A, Anne Wojcicki secured Sequoia Capital as their lead investor, setting favorable terms.'
                },
                {
                    name: 'Participation Rights',
                    description: 'Rights allowing preferred shareholders to receive their money back and then participate in remaining proceeds with common shareholders.',
                    examples: 'With participating preferred shares, investors first get their investment back, then share in remaining proceeds proportional to their ownership.'
                }
            ]
        },
        {
        ...
        },
        {
            ...
            examples: 'Typical founder vesting is over 4 years with a one-year cliff, meaning no equity vests until after the first year.'
        },
        {
            name: 'Drag-Along Rights',
            description: 'Provision allowing majority shareholders to force minority shareholders to join in the sale of a company.',
            examples: 'If investors with 70% ownership want to sell the company, drag-along rights can require the remaining 30% to sell their shares too.'
        },
        {
            name: 'Pay-to-Play',
            description: 'Provision requiring investors to participate in future financing rounds to maintain their preferential rights.',
            examples: "If an investor doesn't participate in the next round proportionally, they might lose their liquidation preference or be converted to common shares."
        }
    ]
},
    {
        ...
        terms: [
        ...
        },
            {
                ...
                examples: 'Founder Shan-Lyn Ma of Zola was able to take some money off the table through a secondary sale during their Series D.'
        },
            {
                name: 'Growth Metrics',
                description: 'Key performance indicators like revenue growth, unit economics, and retention that drive late-stage valuations.',
        ...
        },
            {
                ...
                examples: 'Bumble raised a pre-IPO round that valued the company at $8B before its public offering reached a $13B valuation.'
        },
            {
                name: 'Crossover Investors',
                description: 'Investment firms that invest in both private and public companies, typically entering in late-stage rounds.',
        ...
        },
{
    ...
    examples: 'When Stitch Fix founder Katrina Lake took her company public, she was holding her baby on the trading floor, becoming an iconic image for women founders.'
},
{
    name: 'Direct Listing',
...
},
{
    name: 'Lock-up Period',
        description: 'Time period after an IPO during which company insiders cannot sell their shares.',
            examples: 'Typical lock-up periods range from 90-180 days after the IPO date to prevent insiders from immediately selling shares.'
},
{
    name: 'Earnout',
        description: 'Contingent payment in an acquisition that depends on the acquired company meeting certain performance targets.',
            examples: 'When The Knot acquired WeddingWire, part of the deal included future payments based on revenue growth targets.'
},
{
    name: 'SPAC (Special Purpose Acquisition Company)',
        description: 'A company with no commercial operations formed to raise capital through an IPO for the purpose of acquiring an existing company.',
            examples: '23andMe went public through a SPAC merger with VG Acquisition Corp in 2021, valued at $3.5B.'
},
{
    name: 'Acqui-hire',
        description: "Acquisition primarily to gain access to the target company's talent rather than its products or services.",
    examples: 'Many tech giants like Google and Meta regularly perform acqui-hires of promising startups for their engineering teams.'
}
      ]
    },
{
        ...
        title: 'Legal Documents',
                    ...
                    videoId: 'exampleJKL',
                        terms: [
                            ...
                            },
                            {
                                ...
                                examples: 'Bylaws typically cover topics like how board meetings are conducted, voting procedures, and officer responsibilities.'
                            },
                            {
          ...
          description: 'Agreement specifying the rights of investors, including information rights and registration rights.',
                            ...
                            },
                            {
                                ...
                                examples: 'If a founder wants to sell their shares, the company or existing investors may have the right to purchase them first.'
                            },
                            {
                                name: 'Confidentiality Agreement (NDA)',
                                description: 'Legal contract between parties that outlines confidential information that will be shared but should be restricted from public access.',
    ...
    if (searchQuery) {
        ...
        fundingStages.forEach(stage => {
            stage.terms.forEach(term => {
                if (term.name.toLowerCase().includes(searchQuery.toLowerCase()) ||
        ...
        {showModal && selectedTerm && (
            ...
            >
                <div className="modal-content" ref={modalRef}>
                    ...
                    <h3 id="modal-title" className="term-title">{selectedTerm.name}</h3>
                    <div className="term-full-description">
                        ...
                        <div className="related-resources">
                            ...
                            <ul className="resource-links">
                                <li><a href="#" aria-label={`Watch video about ${selectedTerm.name}`}>📹 Watch explanation video</a></li>
                                <li><a href="#" aria-label={`Read case study about ${selectedTerm.name}`}>📝 Read case study</a></li>
                                <li><a href="#" aria-label={`Download template for ${selectedTerm.name}`}>📄 Download template</a></li>
                            </ul>
                        </div>
                        ...
                        <div className="community-tips">
                            ...
                            <div className="community-tip">
                                <p>"When negotiating {selectedTerm.name}, always get a lawyer to review the terms. I saved myself from a bad deal by understanding the implications."</p>
            ...
            <div className="footer-content">
                ...
                <div className="footer-section">
                    ...
                    <div className="social-links">
                        <a href="#" aria-label="LinkedIn"><span className="social-icon">LinkedIn</span></a>
                        <a href="#" aria-label="Twitter"><span className="social-icon">Twitter</span></a>
                        <a href="#" aria-label="Instagram"><span className="social-icon">Instagram</span></a>
                    </div>
